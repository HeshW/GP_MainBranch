...
SYMPTOM_RULES: list[dict[str, Any]] = [
    ...
    {
        "symptoms": {"wheezing", "dizziness", "flushing", "shortness of breath"},
        "condition": "Anaphylaxis",
        "confidence": "moderate",
        "severity": "critical",
        "min_matches": 2,
        "text_any": ("after eating", "peanuts", "throat tighten", "throat tight", "allergic"),
        "evidence_fmt": "Allergic reaction red-flag cluster detected: {matched}{context_clause}.",
    },
    {
        "symptoms": {"palpitations", "tingling", "shortness of breath", "dizziness"},
        "condition": "Panic attack",
        "confidence": "moderate",
        "severity": "moderate",
        "min_matches": 2,
        "text_any": ("choking", "scared", "might die", "afraid", "suddenly"),
        "evidence_fmt": "Panic-like autonomic symptom cluster detected: {matched}{context_clause}.",
    },
    {
        ...
        "severity": "high",
        "min_matches": 2,
        "text_any": ("irregular", "irregular way", "irregular heartbeat", "irregular pulse"),
        "evidence_fmt": "Irregular-palpitations cardiopulmonary pattern detected: {matched}{context_clause}.",
    },
    {
        ...
        "severity": "moderate",
        "min_matches": 1,
        "text_any": ("ankle", "ankles", "swollen", "end of the day", "leg swelling"),
        "evidence_fmt": "Localized swelling pattern detected: {matched}{context_clause}.",
    },
    {
        ...
        "severity": "high",
        "min_matches": 2,
        "text_any": ("upper stomach", "epigastric", "poor appetite", "losing weight", "past months"),
        "evidence_fmt": "Concerning abdominal weight-loss pattern detected: {matched}{context_clause}.",
    },
    {
        "symptoms": {"ptosis", "double vision", "difficulty speaking", "difficulty swallowing", "weakness"},
        "condition": "Myasthenia gravis",
        "confidence": "moderate",
        "severity": "high",
        "min_matches": 2,
        "text_any": ("eyelids droop", "double vision", "swallowing", "speech", "weaker with use", "later in the day"),
        "evidence_fmt": "Fatigable ocular/bulbar weakness pattern detected: {matched}{context_clause}.",
    },
    {
        "symptoms": {"sore throat", "fever", "nasal congestion", "hoarseness"},
        "condition": "Viral pharyngitis",
        "confidence": "moderate",
        "severity": "moderate",
        "min_matches": 2,
        "text_any": ("sore", "scratchy", "runny nose", "mild fever", "hoarse", "since yesterday"),
        "evidence_fmt": "Viral pharyngitis pattern detected: {matched}{context_clause}.",
    },
    {
        "symptoms": {"nasal congestion", "facial pressure", "fever"},
        "condition": "Acute rhinosinusitis",
        "confidence": "moderate",
        "severity": "moderate",
        "min_matches": 3,
        "text_any": ("past week", "thick yellow", "fever", "blocked nose", "facial pressure"),
        "evidence_fmt": "Acute sinusitis pattern detected: {matched}{context_clause}.",
    },
    {
        "symptoms": {"nasal congestion", "facial pressure"},
        "condition": "Chronic rhinosinusitis",
        "confidence": "moderate",
        "severity": "moderate",
        "min_matches": 2,
        "text_any": ("months", "keeps coming back", "reduced smell", "chronic"),
        "evidence_fmt": "Chronic sinusitis pattern detected: {matched}{context_clause}.",
    },
]
