...
- `FAISS_INDEX_DIR=backend/artifacts/faiss_data_natural`
...
- Cause: wrong working directory causes relative model/index paths to fail.
- Fix: always run backend from repo root.
